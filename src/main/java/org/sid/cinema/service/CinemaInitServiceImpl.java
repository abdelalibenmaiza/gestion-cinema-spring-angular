...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initSeances() {
		...
		Stream.of("12:00","15:00","17:00","17:00","21:00").forEach(s->{
	...
	public void initFilms() {
		...
		Stream.of("HOW TO GET AWAY WITH THE MURDER","LUPIN","NARCOS","PEAKY BLINDERS","SCANDAL","CASA DE PAPEL").forEach( f -> {
			Film film =new Film();
			film.setTitre(f);
	...
	public void initTickets() {
		projectionRepository.findAll().forEach(proj ->{
			for (int i = 0; i < proj.getSalle().getNombrePlace(); i++) {
